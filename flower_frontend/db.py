...
class SQLDatabaseManager:
    ...
    def get_user_by_username(self, username):
        ...
        try:
            ...
            raise Exception(f"获取用户信息失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_user_roles(self, user_id):
        ...
        try:
            ...
            raise Exception(f"获取用户角色失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_user_permissions(self, user_id):
        ...
        try:
            ...
            raise Exception(f"获取用户权限失败: {e!s}")
        finally:
            conn.close()
    ...
    def check_user_permission(self, user_id, permission_name):
        ...
        try:
            ...
            raise Exception(f"检查用户权限失败: {e!s}")
        finally:
            conn.close()
    ...
    def save_recognition_result(self, user_id, image_path, result, confidence):
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"保存识别结果失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_user_recognition_results(self, user_id):
        ...
        try:
            ...
            raise Exception(f"获取识别结果失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_posts(self, limit=20, offset=0):
        ...
        try:
            ...
            raise Exception(f"获取帖子列表失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_post_by_id(self, post_id):
        ...
        try:
            ...
            raise Exception(f"获取帖子详情失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_comments_by_post_id(self, post_id):
        ...
        try:
            ...
            raise Exception(f"获取评论列表失败: {e!s}")
        finally:
            conn.close()
    ...
    def is_post_liked_by_user(self, post_id, user_id):
        ...
        try:
            ...
            raise Exception(f"检查点赞状态失败: {e!s}")
        finally:
            conn.close()
    ...
    def follow_user(self, follower_id, following_id):
        ...
        try:
            # 检查是否已经关注
            cursor.execute(
                "SELECT id FROM follows WHERE follower_id = %s AND following_id = %s", (follower_id, following_id)
            )
            if cursor.fetchone():
                return False  # 已经关注过
    ...
    def unfollow_user(self, follower_id, following_id):
        ...
        try:
            cursor.execute(
                "DELETE FROM follows WHERE follower_id = %s AND following_id = %s", (follower_id, following_id)
            )
            conn.commit()
            return cursor.rowcount > 0
        except Exception as e:
            conn.rollback()
            raise Exception(f"取消关注失败: {e!s}")
        finally:
            conn.close()
    ...
    def is_following(self, follower_id, following_id):
        ...
        try:
            ...
            raise Exception(f"检查关注状态失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_user_following(self, user_id):
        ...
        try:
            ...
            raise Exception(f"获取关注列表失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_user_followers(self, user_id):
        ...
        try:
            ...
            raise Exception(f"获取粉丝列表失败: {e!s}")
        finally:
            conn.close()
    ...
    def test_connection(self):
        ...
        try:
            ...
            print(f"数据库连接测试失败: {e!s}")
            return False

    # ==================== 超级管理员端相关操作 ====================

    def create_system_log(
        self, log_level, module, message, user_id=None, username=None, ip_address=None, user_agent=None
    ):
        """创建系统日志."""
        conn = self.get_connection()
        cursor = conn.cursor()
        ...
        try:
            ...
            raise Exception(f"创建系统日志失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_system_logs(self, limit=100, offset=0, log_level=None, module=None, start_time=None, end_time=None):
        ...
        try:
            ...
            raise Exception(f"获取系统日志失败: {e!s}")
        finally:
            conn.close()
    ...
    def record_traffic(self, endpoint, method, ip_address=None, user_id=None, response_status=200, response_time=0):
        ...
        try:
            ...
            raise Exception(f"记录访问流量失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_traffic_stats(self, start_date=None, end_date=None, limit=100):
        ...
        try:
            ...
            raise Exception(f"获取流量统计失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_traffic_by_endpoint(self, start_date=None, end_date=None, limit=20):
        ...
        try:
            ...
            raise Exception(f"获取端点流量统计失败: {e!s}")
        finally:
            conn.close()
    ...
    def record_server_status(self, metric_name, metric_value, unit=None, status="normal"):
        ...
        try:
            ...
            raise Exception(f"记录服务器状态失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_server_status(self, metric_name=None, limit=100):
        ...
        try:
            ...
            raise Exception(f"获取服务器状态失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_latest_server_metrics(self):
        ...
        try:
            ...
            raise Exception(f"获取最新服务器指标失败: {e!s}")
        finally:
            conn.close()
    ...
    def record_admin_operation(
        ...
        try:
            ...
            raise Exception(f"记录管理员操作失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_admin_operations(self, admin_id=None, operation_type=None, limit=100, offset=0):
        ...
        try:
            ...
            raise Exception(f"获取管理员操作记录失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_all_admins(self):
        ...
        try:
            ...
            raise Exception(f"获取管理员列表失败: {e!s}")
        finally:
            conn.close()
    ...
    def update_user_role(self, user_id, role_name):
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"更新用户角色失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_system_summary(self):
        ...
        try:
            ...
            cursor.execute(
                "SELECT COUNT(*) as count FROM system_logs WHERE created_at > %s", (int(time.time()) - 86400,)
            )
            ...
            raise Exception(f"获取系统概要统计失败: {e!s}")
        finally:
            conn.close()
    ...
    def update_user_profile(self, user_id, email=None, password_hash=None):
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"更新用户信息失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_user_recognition_history(self, user_id, limit=20, offset=0):
        ...
        try:
            ...
            raise Exception(f"获取历史识别记录失败: {e!s}")
        finally:
            conn.close()
    ...
    def delete_recognition_result(self, result_id, user_id):
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"删除识别记录失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_user_albums(self, user_id, category=None):
        ...
        try:
            ...
            raise Exception(f"获取相册列表失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_album_by_id(self, album_id, user_id):
        ...
        try:
            ...
            raise Exception(f"获取相册详情失败: {e!s}")
        finally:
            conn.close()
    ...
    def delete_album(self, album_id, user_id):
        ...
        try:
            ...
            conn.rollback()
            raise Exception(f"删除相册失败: {e!s}")
        finally:
            conn.close()

    def add_image_to_album(
        self, album_id, user_id, image_path, flower_name=None, confidence=None, recognition_result_id=None
    ):
        """添加图片到相册."""
        conn = self.get_connection()
        cursor = conn.cursor()
        ...
        try:
            ...
            cursor.execute(
                "UPDATE albums SET image_count = image_count + 1, updated_at = %s WHERE id = %s", (now, album_id)
            )
            ...
            conn.rollback()
            raise Exception(f"添加图片到相册失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_album_images(self, album_id, user_id, limit=50, offset=0):
        ...
        try:
            ...
            cursor.execute(
                "SELECT COUNT(*) as count FROM album_images WHERE album_id = %s AND deleted_at IS NULL", (album_id,)
            )
            total = cursor.fetchone()["count"]

            return images, total
        except Exception as e:
            raise Exception(f"获取相册图片失败: {e!s}")
        finally:
            conn.close()
    ...
    def delete_album_image(self, image_id, album_id, user_id):
        ...
        try:
            ...
            if cursor.rowcount > 0:
                cursor.execute("UPDATE albums SET image_count = image_count - 1 WHERE id = %s", (album_id,))
                conn.commit()
                return True
            return False
        except Exception as e:
            conn.rollback()
            raise Exception(f"删除图片失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_album_categories(self, user_id):
        ...
        try:
            cursor.execute("SELECT DISTINCT category FROM albums WHERE user_id = %s ORDER BY category", (user_id,))
            results = cursor.fetchall()
            return [row["category"] for row in results]
        except Exception as e:
            raise Exception(f"获取相册分类失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_user_feedback(self, user_id, limit=20, offset=0):
        ...
        try:
            ...
            cursor.execute("SELECT COUNT(*) as count FROM user_feedback WHERE user_id = %s", (user_id,))
            total = cursor.fetchone()["count"]

            return results, total
        except Exception as e:
            raise Exception(f"获取反馈列表失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_feedback_by_id(self, feedback_id, user_id):
        ...
        try:
            cursor.execute("SELECT * FROM user_feedback WHERE id = %s AND user_id = %s", (feedback_id, user_id))
            return cursor.fetchone()
        except Exception as e:
            raise Exception(f"获取反馈详情失败: {e!s}")
        finally:
            conn.close()
    ...
    def delete_feedback(self, feedback_id, user_id):
        ...
        try:
            cursor.execute("DELETE FROM user_feedback WHERE id = %s AND user_id = %s", (feedback_id, user_id))
            conn.commit()
            return cursor.rowcount > 0
        except Exception as e:
            conn.rollback()
            raise Exception(f"删除反馈失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_all_feedback(self, status=None, limit=50, offset=0):
        ...
        try:
            ...
            raise Exception(f"获取所有反馈失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_announcements(self, is_active=None, limit=20, offset=0):
        ...
        try:
            if is_active is not None:
                ...
                cursor.execute(
                    "SELECT * FROM announcements ORDER BY created_at DESC LIMIT %s OFFSET %s", (limit, offset)
                )
            results = cursor.fetchall()
            ...
            raise Exception(f"获取公告列表失败: {e!s}")
        finally:
            conn.close()
    ...
    def delete_announcement(self, announcement_id, admin_id):
        ...
        try:
            cursor.execute(
                "UPDATE announcements SET is_active = 0 WHERE id = %s AND admin_id = %s", (announcement_id, admin_id)
            )
            conn.commit()
            return cursor.rowcount > 0
        except Exception as e:
            conn.rollback()
            raise Exception(f"删除公告失败: {e!s}")
        finally:
            conn.close()
    ...
    def get_recycle_bin_items(self, user_id, item_type=None, limit=50, offset=0):
        ...
        try:
            ...
            raise Exception(f"获取回收站项目失败: {e!s}")
        finally:
            conn.close()
    ...
    def restore_from_recycle_bin(self, user_id, recycle_id):
        ...
        try:
            cursor.execute("SELECT * FROM recycle_bin WHERE id = %s AND user_id = %s", (recycle_id, user_id))
            ...
            if item_type == "post":
                cursor.execute("UPDATE posts SET deleted_at = NULL WHERE id = %s", (original_id,))
            elif item_type == "image":
                cursor.execute("UPDATE album_images SET deleted_at = NULL WHERE id = %s", (original_id,))
            elif item_type == "recognition":
                cursor.execute("UPDATE recognition_results SET deleted_at = NULL WHERE id = %s", (original_id,))

            cursor.execute("DELETE FROM recycle_bin WHERE id = %s", (recycle_id,))

            conn.commit()
            return True, f"已恢复{item_type}"
        except Exception as e:
            conn.rollback()
            raise Exception(f"恢复项目失败: {e!s}")
        finally:
            conn.close()
    ...
    def empty_recycle_bin(self, user_id):
        ...
        try:
            cursor.execute("SELECT * FROM recycle_bin WHERE user_id = %s", (user_id,))
...
def record_admin_operation(
    admin_id, admin_username, operation_type, target_type=None, target_id=None, description=None, ip_address=None
):
    return db_manager.record_admin_operation(
        admin_id, admin_username, operation_type, target_type, target_id, description, ip_address
    )
