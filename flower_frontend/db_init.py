...
# 插入初始角色数据
initial_roles = [("admin", "系统管理员"), ("user", "普通用户")]
...
print("数据库初始化完成！")
print(
    "创建的表：users, roles, permissions, user_roles, role_permissions, recognition_results, posts, comments, likes, follows"
)
print("初始角色：admin, user")
print(
    "初始权限：view_results, upload_images, manage_users, manage_roles, view_community, create_posts, comment_posts, like_posts, follow_users"
)
